...
public class SecondSwitch : EventHandler
{
    ...
    {
        currentSkillIndex = GameManager.instance.characterLoading[character.ID].skill2;
    ...
    {
        GameManager.instance.characterLoading[character.ID].skill2 = index;
        GameManager.instance.characterLoading[character.ID].secondSkill.OnChangeSkill(character.Skills[index]);
